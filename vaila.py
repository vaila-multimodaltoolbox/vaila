...
text = r"""
    vailá - 11.Sep.2026 v0.3.137 (Python 3.12.14)
                                             o
                                _,  o |\  _,/
                          |  |_/ |  | |/ / |
                           \/  \/|_/|/|_/\/|_/
...
class Vaila(tk.Tk):
    def __init__(self, *, gui: bool = True):
        ...
        self.title("vailá - 11.Sep.2026 v0.3.137 (Python 3.12.14)")
    ...
    def transfer_file(self):
        """Collect SSH parameters and track the shared interactive transfer."""
    ...
    def cut_video(self):
        ...
        """
        # Run in a separate process: cutvideo creates its own Tk root and a
        # blocking pygame event loop. Running it in-process shares the Tcl/Tk
        # interpreter with the main vailá GUI and freezes it on exit
    ...
    # B5_r6_c3 - tugturn
    def tugturn(self):
        """Runs the tugturn analysis tool."""
        print("\n" + "=" * 60)
