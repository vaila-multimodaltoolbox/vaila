...
# From FIFA-Skeletal-Tracking-Starter-Kit-2026 (lib/camera_tracker.py); see NOTICE.md in this package.
# Minor fix: initialize dist_map when refine_mask is false; guard snap-to-mask branch.
...
class CameraTracker:
    ...
    def __init__(
        ...
        fps: float = 30.0,
        options: CameraTrackerOptions | None = None,
    ):
        """
    ...
    def _update_flow(
        ...
        if dist_labels is not None and label2yx is not None and dist_map is not None:
