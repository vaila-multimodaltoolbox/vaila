                    ...
                    if point.extensions:
                        for ext in point.extensions:
                            if ext.tag.endswith('TrackPointExtension'):
                                ...
                                cad = float(cad_text) if cad_text else None  # Corrigido para aceitar floats
...
def export_to_csv(points: List[Dict[str, Any]], output_csv_file: str) -> None:
    ...
    """
    fieldnames = ['latitude', 'longitude', 'elevation', 'time', 'speed', 'cad', 'time_seconds']
...
def convert_csv_to_gpx():
    ...
    try:
        ...
        for _, row in df.iterrows():
            ...
            wp = gpxpy.gpx.GPXWaypoint(latitude=row['latitude'], longitude=row['longitude'],
                                       elevation=row.get('elevation', None), time=t)
...
def distance_analysis():
    messagebox.showinfo("Distance Analysis", "Distance analysis functionality is not implemented yet.")
...
def trajectory_analysis():
    messagebox.showinfo("Trajectory Analysis", "Trajectory analysis functionality is not implemented yet.")

def spatial_analysis():
    messagebox.showinfo("Spatial Analysis", "Spatial analysis functionality is not implemented yet.")

def time_series_analysis():
    messagebox.showinfo("Time Series Analysis", "Time series analysis functionality is not implemented yet.")

def data_normalization():
    messagebox.showinfo("Data Normalization", "Data normalization functionality is not implemented yet.")

def data_visualization():
    messagebox.showinfo("Data Visualization", "Data visualization functionality is not implemented yet.")

def batch_processing():
    messagebox.showinfo("Batch Processing", "Batch processing functionality is not implemented yet.")
...
def plot_gnss_data():
    ...
    if lats and lons:
        ...
        name_no_ext, _ = os.path.splitext(base)
        timestamp = datetime.now().strftime("%Y%m%d_%H%M%S")
        map_file = os.path.join(os.path.dirname(file_path), f"{name_no_ext}_{timestamp}_interactive.html")
        m.save(map_file)
