...
def create_dumbbell_chart(run_stats, output_dir):
    ...
    # Keep legend outside to avoid overlap with dense lines.
...
def create_improvement_scatter(run_stats, output_dir):
    """
    Create a scatter plot of sequential run-to-run speed changes.
    ...
    if not transitions:
        print("Warning: No valid sequential transitions found for scatter plot.")
        return None
    ...
    # Add deterministic jitter by athlete hash to reduce overlap.
    ...
    ax.grid(True, linestyle="-", alpha=0.3)
    legend_elements = [
        plt.Line2D([0], [0], marker="o", color="w", markerfacecolor="#2ecc71", markersize=9, label="Improved"),
        plt.Line2D([0], [0], marker="o", color="w", markerfacecolor="#e74c3c", markersize=9, label="Declined"),
        plt.Line2D([0], [0], marker="o", color="w", markerfacecolor="#95a5a6", markersize=9, label="No Change"),
    ]
