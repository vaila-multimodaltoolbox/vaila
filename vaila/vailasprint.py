...
- 2 X COD-180 degree total distance of 20m: Change of Direction analysis (Planned).
"""
...
def generate_general_report(all_data, output_dir, logo_b64, mode="sprint"):
    ...
    <body>
        <div class="container">
            {logo_html}
            <h1><i>vailá</i> {report_title} - General Report</h1>
            <p style="text-align: center;"><strong>Processed:</strong> {len(all_data)} data points from {run_stats.shape[0]} runs.</p>
            
            <div style="text-align: center; margin: 20px;">
                <a href="{profiling_filename}" class="btn" target="_blank">View Statistical Profiling</a>
