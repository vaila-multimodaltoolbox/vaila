        ...
        if file_type == 'csv' and file_name.endswith('.csv'):
            try:
                ...
                if data is not None:
                    ...
                    base_dir_figures = os.path.join(output_directory, "IMU_multimodal_results", f'figure/IMU_{file_name}_{current_time}')
                    base_dir_processed_data = os.path.join(output_directory, "IMU_multimodal_results", f'processed_data/IMU_{file_name}_{current_time}')
