...
def calc_cop_simplified(data, board_height_m: float = 0.0, moment_unit: str = "N.m", threshold: float = 5.0):
    """
...
def main():
    ...
    for file_name in files:
        ...
        df_shimba = pd.DataFrame(
            cop_xyz_shimba_mm, columns=["cop_ap_mm", "cop_ml_mm", "cop_z_mm"]
        )
