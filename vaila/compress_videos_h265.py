...
def run_compress_videos_h265(temp_file_path, output_directory, preset="medium", crf=23, use_gpu=False):
    ...
    for video_file in video_files:
        ...
        output_path = os.path.join(output_directory, f"{os.path.splitext(relative_path)[0]}_h265.mp4")
        ...
        if use_gpu:
            ...
            command = [
                ...
                "-c:v", "hevc_nvenc",  # Use NVIDIA NVENC for H.265
            ...
            command = [
                ...
                "-y",  # overwrite output files
                "-i", input_path,  # input file
                "-c:v", "libx265",  # video codec for H.265
                "-preset", preset,  # preset for encoding speed
