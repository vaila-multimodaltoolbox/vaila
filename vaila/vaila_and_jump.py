...
def process_jump_data(
    input_file, output_dir, use_time_of_flight, gravity=9.81, decimals=3
):
    """
    ...
    try:
        ...
        for index, row in data.iterrows():
            ...
            relative_power = (
                calculate_relative_power(average_power, mass)
            ...
            jpi = (
                calculate_jump_performance_index(height, force, contact_time)
                if pd.notna(contact_time) and force is not None
                else None
            )
            ...
            results.append(
                {
                    ...
                    "total_time_s": (
                        format_number(time_of_flight + contact_time)
...
def process_all_files_in_directory(
    target_dir, use_time_of_flight, gravity=9.81, decimals=3
):
    """
