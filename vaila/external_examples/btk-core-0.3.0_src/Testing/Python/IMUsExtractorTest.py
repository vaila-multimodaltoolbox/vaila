...
class IMUsExtractorTest(unittest.TestCase):
    ...
    def test_OneAcquisition(self):
        ...
        self.assertEqual(
            output.GetItem(0).GetAccelerometerX().GetLabel(), acq.GetAnalog(0).GetLabel()
        )
        self.assertEqual(
            output.GetItem(0).GetAccelerometerY().GetLabel(), acq.GetAnalog(1).GetLabel()
        )
        self.assertEqual(
            output.GetItem(0).GetAccelerometerZ().GetLabel(), acq.GetAnalog(2).GetLabel()
        )
    ...
    def test_OneAcquisition_NoDescriptions(self):
        ...
        self.assertEqual(
            output.GetItem(0).GetAccelerometerX().GetLabel(), acq.GetAnalog(5).GetLabel()
        )
        self.assertEqual(
            output.GetItem(0).GetAccelerometerY().GetLabel(), acq.GetAnalog(4).GetLabel()
        )
        self.assertEqual(
            output.GetItem(0).GetAccelerometerZ().GetLabel(), acq.GetAnalog(3).GetLabel()
        )
    ...
    def test_OneAcquisition_TwoSensors(self):
        ...
        self.assertEqual(
            output.GetItem(1).GetAccelerometerX().GetLabel(), acq.GetAnalog(6).GetLabel()
        )
        self.assertEqual(
            output.GetItem(1).GetAccelerometerY().GetLabel(), acq.GetAnalog(7).GetLabel()
        )
        self.assertEqual(
            output.GetItem(1).GetAccelerometerZ().GetLabel(), acq.GetAnalog(8).GetLabel()
        )
    ...
    def test_TwoAcquisitions(self):
        ...
        self.assertEqual(output.GetItem(0).GetDescription(), "BAR")
        self.assertEqual(
            output.GetItem(0).GetAccelerometerX().GetLabel(), acq1.GetAnalog(0).GetLabel()
        )
        self.assertEqual(
            output.GetItem(0).GetAccelerometerY().GetLabel(), acq1.GetAnalog(1).GetLabel()
        )
        self.assertEqual(
            output.GetItem(0).GetAccelerometerZ().GetLabel(), acq1.GetAnalog(2).GetLabel()
        )
        ...
        self.assertEqual(output.GetItem(1).GetDescription(), "")
        self.assertEqual(
            output.GetItem(1).GetAccelerometerX().GetLabel(), acq2.GetAnalog(0).GetLabel()
        )
        self.assertEqual(
            output.GetItem(1).GetAccelerometerY().GetLabel(), acq2.GetAnalog(1).GetLabel()
        )
        self.assertEqual(
            output.GetItem(1).GetAccelerometerZ().GetLabel(), acq2.GetAnalog(2).GetLabel()
        )
        ...
        self.assertEqual(
            output.GetItem(2).GetAccelerometerX().GetLabel(), acq2.GetAnalog(6).GetLabel()
        )
        self.assertEqual(
            output.GetItem(2).GetAccelerometerY().GetLabel(), acq2.GetAnalog(7).GetLabel()
        )
        self.assertEqual(
            output.GetItem(2).GetAccelerometerZ().GetLabel(), acq2.GetAnalog(8).GetLabel()
        )
        self.assertEqual(output.GetItem(2).GetGyroscopeX().GetLabel(), acq2.GetAnalog(9).GetLabel())
        self.assertEqual(
            output.GetItem(2).GetGyroscopeY().GetLabel(), acq2.GetAnalog(10).GetLabel()
        )
        self.assertEqual(
            output.GetItem(2).GetGyroscopeZ().GetLabel(), acq2.GetAnalog(11).GetLabel()
        )
