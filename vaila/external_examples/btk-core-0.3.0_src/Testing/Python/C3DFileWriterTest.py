...
class C3DFileWriterTest(unittest.TestCase):
    ...
    def test_sample01_Eb015pi_rewrited(self):
        ...
        for i in range(0, 50):
            self.assertAlmostEqual(
                acq.GetAnalog(0).GetValues()[i], acqRef.GetAnalog(0).GetValues()[i], 4
            )
            self.assertAlmostEqual(
                acq.GetAnalog(1).GetValues()[i], acqRef.GetAnalog(1).GetValues()[i], 4
            )
            self.assertAlmostEqual(
                acq.GetAnalog(0).GetValues()[i], acqRef.GetAnalog(0).GetValues()[i], 4
            )
        ...
        self.assertEqual(
            len(acq.GetMetaData().GetChild("EVENT").GetChild("TIMES").GetInfo().GetDimensions()), 2
        )
        self.assertEqual(
            acq.GetMetaData().GetChild("EVENT").GetChild("TIMES").GetInfo().GetDimensions()[0], 2
        )
        self.assertEqual(
            acq.GetMetaData().GetChild("EVENT").GetChild("TIMES").GetInfo().GetDimensions()[1], 3
        )
    ...
    def test_sample01_Eb015pr_rewrited(self):
        ...
        for i in range(0, 50):
            self.assertAlmostEqual(
                acq.GetPoint(0).GetResiduals()[i], acqRef.GetPoint(0).GetResiduals()[i], 3
            )
            self.assertAlmostEqual(
                acq.GetPoint(14).GetResiduals()[i], acqRef.GetPoint(14).GetResiduals()[i], 3
            )
            self.assertAlmostEqual(
                acq.GetAnalog(0).GetValues()[i], acqRef.GetAnalog(0).GetValues()[i], 4
            )
    ...
    def test_sample09_PlugInC3D_rewrited(self):
        ...
        self.assertAlmostEqual(
            acq2.GetMetaData().GetChild("ANALOG").GetChild("RATE").GetInfo().ToDouble(0),
            acq.GetAnalogFrequency(),
            5,
        )
        ...
        for i in range(0, 50):
            for j in range(0, acq.GetPointNumber()):
                self.assertAlmostEqual(
                    acq.GetPoint(j).GetValues()[i, 0], acq2.GetPoint(j).GetValues()[i, 0], 4
                )
                self.assertAlmostEqual(
                    acq.GetPoint(j).GetValues()[i, 1], acq2.GetPoint(j).GetValues()[i, 1], 4
                )
                self.assertAlmostEqual(
                    acq.GetPoint(j).GetValues()[i, 2], acq2.GetPoint(j).GetValues()[i, 2], 4
                )
                self.assertAlmostEqual(
                    acq.GetPoint(j).GetResiduals()[i], acq2.GetPoint(j).GetResiduals()[i], 4
                )
            for j in range(0, acq.GetAnalogNumber()):
                self.assertAlmostEqual(
                    acq.GetAnalog(j).GetValues()[i], acq2.GetAnalog(j).GetValues()[i], 4
                )
    ...
    def test_sample19_sample19_rewrited(self):
        ...
        for i in range(0, 50, 10):
            self.assertAlmostEqual(
                acq.GetAnalog(0).GetValues()[i], acq2.GetAnalog(0).GetValues()[i], 4
            )
            self.assertAlmostEqual(
                acq.GetAnalog(1).GetValues()[i], acq2.GetAnalog(1).GetValues()[i], 4
            )
    ...
    def test_convertTRC2C3D(self):
        ...
        for i in range(0, 50):
            self.assertAlmostEqual(
                acq.GetPoint(1).GetValues()[i, 0], acq2.GetPoint(1).GetValues()[i, 0], 4
            )
            self.assertAlmostEqual(
                acq.GetPoint(2).GetValues()[i, 1], acq2.GetPoint(2).GetValues()[i, 1], 4
            )
            self.assertAlmostEqual(
                acq.GetPoint(3).GetValues()[i, 2], acq2.GetPoint(3).GetValues()[i, 2], 4
            )
            self.assertAlmostEqual(
                acq.GetPoint(4).GetResiduals()[i], acq2.GetPoint(4).GetResiduals()[i], 4
            )

        self.assertAlmostEqual(
            acq.GetPoint(70).GetResiduals()[82], acq2.GetPoint(70).GetResiduals()[82], 5
        )
    ...
    def test_acq100000(self):
        ...
        self.assertEqual(
            output.GetMetaData().GetChild("POINT").GetChild("FRAMES").GetInfo().ToInt(0), -1
        )
    ...
    def test_UTF8(self):
        ...
        writer.SetInput(reader.GetOutput())
        writer.SetFilename(
            _TDDConfigure.C3DFilePathOUT + "Я могу есть стекло, оно мне не вредит - python.c3d"
        )
        writer.Update()
        reader2 = btk.btkAcquisitionFileReader()
        reader2.SetFilename(
