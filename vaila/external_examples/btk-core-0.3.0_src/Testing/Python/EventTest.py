...
class EventTest(unittest.TestCase):
    ...
    def test_ctor_time(self):
        e = btk.btkEvent(
            "FOO", 1.52, "Right", btk.btkEvent.Manual, "Bar", "Simple test with time", 1
        )
    ...
    def test_ctor_frame(self):
        e = btk.btkEvent(
            "FOO", 144, "Right", btk.btkEvent.Manual, "Bar", "Simple test with frame", 1
        )
        self.assertEqual(e.GetLabel(), "FOO")
    ...
    def test_ctor_both(self):
        e = btk.btkEvent(
            "FOO", 1.52, 144, "Right", btk.btkEvent.Manual, "Bar", "Simple test with both", 1
        )
        self.assertEqual(e.GetLabel(), "FOO")
        self.assertEqual(e.GetTime(), 1.52)
        self.assertEqual(e.GetFrame(), 144)
