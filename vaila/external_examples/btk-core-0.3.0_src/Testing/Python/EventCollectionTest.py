...
class EventCollectionTest(unittest.TestCase):
    ...
    def test_insert_index_middle(self):
        ...
        ec.InsertItem(
            1, btk.btkEvent("FOOBAR", 5.05, "General", btk.btkEvent.Automatic, "FooBar", "", 3)
        )
    ...
    def test_iterator_insert_begin(self):
        ec = btk.btkEventCollection()
        ec.InsertItem(
            ec.Begin(), btk.btkEvent("FOO", 1.52, "Right", btk.btkEvent.Manual, "Bar", "", 1)
        )
        ec.InsertItem(
            ec.Begin(), btk.btkEvent("BAR", 2.03, "Left", btk.btkEvent.Automatic, "Foo", "", 2)
        )
        e2 = ec.GetItem(0)
        self.assertEqual(e2.GetLabel(), "BAR")
        self.assertEqual(e2.GetTime(), 2.03)
    ...
    def test_iterator_insert_end(self):
        ec = btk.btkEventCollection()
        ec.InsertItem(
            ec.End(), btk.btkEvent("FOO", 1.52, "Right", btk.btkEvent.Manual, "Bar", "", 1)
        )
        ec.InsertItem(
            ec.End(), btk.btkEvent("BAR", 2.03, "Left", btk.btkEvent.Automatic, "Foo", "", 2)
        )
        e2 = ec.GetItem(1)
        self.assertEqual(e2.GetLabel(), "BAR")
        self.assertEqual(e2.GetTime(), 2.03)
    ...
    def test_iterator_insert_middle(self):
        ...
        i.incr()
        ec.InsertItem(
            i, btk.btkEvent("FOOBAR", 5.05, "General", btk.btkEvent.Automatic, "FooBar", "", 3)
        )
        self.assertEqual(ec.GetItemNumber(), 3)
        e = ec.GetItem(1)
        self.assertEqual(e.GetLabel(), "FOOBAR")
    ...
    def test_iterator_remove_begin(self):
        ...
        ec.InsertItem(btk.btkEvent("BAR", 2.03, "Left", btk.btkEvent.Automatic, "Foo", "", 2))
        ec.InsertItem(
            btk.btkEvent("FOOBAR", 5.05, "General", btk.btkEvent.Automatic, "FooBar", "", 3)
        )
        self.assertEqual(ec.GetItemNumber(), 3)
