...
MediaPipe's FaceMesh model. It processes videos from a specified input directory,
overlays face landmarks on each video frame, and exports both normalized and
...
def process_video(video_path, output_dir, face_config):
    """
...
def process_videos_in_directory(existing_root=None):
    ...
    for i, video_file in enumerate(video_files, 1):
        ...
        try:
            process_video(video_file, output_dir, face_config)
        except Exception as e:
