...
Optional stacks: root [`README.md`](../README.md) and [`AGENTS.md`](../AGENTS.md).
...
See [`CONTRIBUTING.md`](../CONTRIBUTING.md), AGPL-3.0 `LICENSE`, and the BibTeX entry in [`index.md`](index.md).
