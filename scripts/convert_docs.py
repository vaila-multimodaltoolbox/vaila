...
def convert_table_to_markdown(table):
    ...
    markdown += "| " + " | ".join(cell.get_text().strip() for cell in header_cells) + " |\n"
    markdown += "|" + "|".join("---" for _ in header_cells) + "|\n"
    
    # Data rows
    for row in rows[1:]:
        cells = row.find_all('td')
        markdown += "| " + " | ".join(cell.get_text().strip() for cell in cells) + " |\n"
...
def main():
    ...
    conversions = [
        ('vaila/help/markerless_2D_analysis_br_help.html', 'docs/modules/markerless-analysis/markerless-2d-video.md'),
        ('vaila/help/getpixelvideo_help.html', 'docs/modules/tools/get-pixel-coordinates.md'),
        ('vaila/help/dlt3d_and_rec3d.html', 'docs/modules/tools/dlt3d-reconstruction.md'),
