<!-- Use this template to compile the solution design that you generate based on
...
| Component    | Recommended     | Justification | Alternatives | Pros and     |
:              : Google Cloud    : and citations : considered   : cons of      :
:              : product/feature :               :              : alternatives :
| :----------- | :-------------- | :------------ | :----------- | :----------- |
| **[Component | **[Product      | [Why this     | [Alternative | **Pros**:    |
: Name]**      : Name]**         : product is    : product]     : ... <br>     :
:              :                 : chosen,       :              : **Cons**\:   :
:              :                 : citing        :              : ...          :
:              :                 : official      :              :              :
:              :                 : docs]         :              :              :
