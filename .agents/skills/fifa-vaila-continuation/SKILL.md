...
- `.Codex/skills/fifa-skeletal-tracking/SKILL.md` — full FIFA pipeline reference.
- `.Codex/skills/sam3-video/SKILL.md` — SAM 3 video segmentation reference.
- `.Codex/skills/soccer-field-keypoints-yolo/SKILL.md` — pitch-keypoint training/inference.
...
- `.Codex/skills/yolo-fb-gui-cli/SKILL.md` — YOLO + FB chooser + GUI→CLI mirror.
...
`.Codex/skills/soccer-field-keypoints-yolo/SKILL.md`
