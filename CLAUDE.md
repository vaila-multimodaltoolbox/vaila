...
| Frame B (r4) | **YOLO + FB** (chooser: Tracker/Pose/Seg v26, SAM 3 video, Sapiens2 Pose, SAM3+Sapiens2, SAM3+Sapiens2 Visualize ID, SAM3+DINOv3 3D, SAM3+DINOv3 Visualize ID, Train YOLOv26) · ML Walkway · Markerless Hands · MP Angles · Markerless Live |
